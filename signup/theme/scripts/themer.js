...
[
	...
	".left-menu #menu > ul > li.active > a, .right-menu #menu > ul > li.active > a",
	".left-menu #menu > ul > li a:hover, .right-menu #menu > ul > li a:hover",
	".left-menu #menu > ul ul li.active a, .right-menu #menu > ul ul li.active a",
	".left-menu #menu .profile span a, .right-menu #menu .profile span a",
	".left-menu #menu .profile span a i:before, .right-menu #menu .profile span a i:before"
];
...
[
	...
	".widget-stats.line",
	".fc-event-skin",
	".left-menu #menu .profile .img, .right-menu #menu .profile .img"
];
