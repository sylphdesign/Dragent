$(document).ready(function(){
	...
	$("#about .pxarrows").parallax("50%", 1650, 0.5, true);
	$("#about .pxcircle1").parallax("50%", 1600, 0.5, true);
	$("#about .pxcircle2").parallax("50%", 2120, 0.1, true);
	$("#about .pxcircle3").parallax("50%", 1350, 0.7, true);
	$("#about .pxcircle4").parallax("50%", 1055, 1.3, true);
	$("#about .pximage").parallax("50%", 1500, 0.6, true);
	...
	$("#services .pxcircles").parallax("50%", 1800, 0.6, true);
	...
	$("#services .px3d").parallax("50%", 2350, 0.3, false);
